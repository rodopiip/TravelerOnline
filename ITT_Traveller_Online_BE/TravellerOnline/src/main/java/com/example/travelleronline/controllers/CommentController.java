...
public class CommentController extends AbstractController {
    ...
    public ContentDTO replyToPost(@PathVariable("id") int postId, @RequestBody ContentDTO contentData, HttpSession session) {
        return commentService.replyByPost(contentData,postId, getLoggedId(session));
    }
    ...
    //delete
    //todo : suggestion : refactor: deleteByUserSessionId Answer: delteCommentById is fine.
